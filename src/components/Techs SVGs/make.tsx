...
const Make = (props: SVGProps<SVGSVGElement>) => (
  <svg {...props} id="Vrstva_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 882.62 182.13">
    <defs>
      ...
      <clipPath id="clipPath">
        <path className="cls-1" d="m156.04,44.34h33.88c2.58,0,4.68,2.1,4.68,4.68v125.07c0,2.58-2.1,4.68-4.68,4.68h-33.88c-2.58,0-4.68-2.1-4.68-4.68V49.02c0-2.58,2.1-4.68,4.68-4.68Z" />
      </clipPath>
      ...
      <clipPath id="clipPath-1">
        <path className="cls-1" d="m56.66,45.99L.5,157.74c-1.16,2.31-.23,5.12,2.08,6.28l30.27,15.21c2.31,1.16,5.12.23,6.28-2.08l56.16-111.75c1.16-2.31.23-5.12-2.08-6.28l-30.27-15.21c-.68-.34-1.39-.5-2.1-.5-1.71,0-3.36.94-4.18,2.58" />
      </clipPath>
      ...
      <clipPath id="clipPath-2">
        <path className="cls-1" d="m103.9,46.39l-24.03,121.81c-.5,2.53,1.14,4.98,3.67,5.49l33.21,6.7c2.54.51,5.02-1.14,5.52-3.68l24.03-121.81c.5-2.53-1.14-4.98-3.67-5.49l-33.21-6.7c-.31-.06-.62-.09-.93-.09-2.19,0-4.15,1.54-4.59,3.77" />
      </clipPath>
    ...
    <g className="cls-2">
      <rect className="cls-7" x="129.45" y="41.01" width="87.08" height="141.09" transform="translate(-27.91 66.73) rotate(-20.24)" />
    </g>
    <g className="cls-5">
      <rect className="cls-4" x="-23.86" y="29.77" width="143.51" height="164.28" transform="translate(-40.48 28.2) rotate(-23.38)" />
    </g>
    <g className="cls-6">
      <rect className="cls-3" x="57.56" y="35.23" width="111.05" height="153.08" transform="translate(-31.65 45.95) rotate(-20.21)" />
    </g>
  </svg>
);
